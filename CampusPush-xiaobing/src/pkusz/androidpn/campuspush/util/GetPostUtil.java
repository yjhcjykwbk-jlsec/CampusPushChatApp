package pkusz.androidpn.campuspush.util;
...
public class GetPostUtil
{
	...
	public static String send(String method, String url, StringBuilder parameter) {
		...
		try {
			...
			httpConn.setDoOutput(true); //设置向HttpUrlConnection输出
			httpConn.setDoInput(true); //设置从HttpUrlConnection输入
			httpConn.setRequestMethod(method); //设置Http请求方式是POST或GET

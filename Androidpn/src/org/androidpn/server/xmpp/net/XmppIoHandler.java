...
import org.androidpn.server.xmpp.router.IQRouter;
...
public class XmppIoHandler implements IoHandler {
    ...
    public void messageReceived(IoSession session, Object message)
        ...
        System.out.println("\n\n\nIOHandler里NotificationManager累积到共"+NotificationManager.sessionCounter+"个消息发送平均延迟："+NotificationManager.difTime+"毫秒\n\n");
        //System.out.println("\n\n\n\n\nIOHandler IQRouter累计共"+IQRouter.counter+"个消息发送平均延迟："+IQRouter.thisdifTime+"毫秒\n\n\n\n\n");
    ...
    public void messageSent(IoSession session, Object message) throws Exception {
        log.debug("xiaobingooooooooooooooooo messageSent()...");
